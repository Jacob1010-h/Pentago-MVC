...
public class Board {
    ...
    public void populateBoard(MiniBoardHelper miniBoardHelper) {
        ...
        // combine all miniBoards into one big board
        // loop through the board, incrementing by the size of a miniBoard (3)
        // for each cell in board, set the value to the value of the corresponding cell in the miniBoard
